                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <c:if test="${sessionScope.user.role==0}">
                                <input type="button" value="添加" onclick="window.open('exam/exam', '_blank', 'height=220, width=500, top=10, left=10')"/> &nbsp;&nbsp;&nbsp;&nbsp;
                            </c:if>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td class="panel-dataGrid-dataColumn">
                            <c:if test="${sessionScope.user.role==0}">
                                ...
                                <a href="javascript:void(0)" onclick="window.open('exam/exam?examId=${exam.examId}', '_blank', 'height=220, width=500, top=10, left=10')">更新</a>&nbsp;&nbsp;&nbsp;&nbsp;
